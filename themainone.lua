        ...
        Toggles.TheMinesAnticheatBypass:OnChanged(function(value)
            if value then
                ...
                if Library.IsMobile then
                    Script.Functions.Alert("We need a ladder to bypass anticheat, we gave you ESP.", progressPart)
                else
                    Script.Functions.Alert("We need a ladder to bypass anticheat, we gave you ESP.", progressPart)
                end
...
Script.Functions.Alert("Lolhax loaded!", 8)